...
const COS = {
  ...
  users: [
    ...
    { id:7,  name:'Tosin Akindele',        role:'Session / Training',   level:'team',  pin:'bp_yi13b9',  sections:['sunday','worship'], active:true },
    { id:8,  name:'Bolaji Adebanjo',       role:'Drums / MD Candidate', level:'team',  pin:'bp_yhrx9h',  sections:['sunday','worship'], active:true },
    ...
    { id:13, name:'Chinedu',               role:'Media Recruit',        level:'team',  pin:'bp_yi1slh',  sections:['sunday','media'], active:true },
    { id:14, name:'Terrel',                role:'Media Recruit',        level:'team',  pin:'bp_yi1v0l',  sections:['sunday','media'], active:true },
    { id:15, name:'Tavoy',                 role:'Media Recruit',        level:'team',  pin:'bp_yi1u9x',  sections:['sunday','media'], active:true },
    { id:16, name:'Noah',                  role:'Media Recruit',        level:'team',  pin:'bp_yi1wp1',  sections:['sunday','media'], active:true },
  ],
