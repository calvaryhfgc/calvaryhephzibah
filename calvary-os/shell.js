...
const COS = {
  ...
  // ── USERS ─────────────────────────────────────────────────────────────────
  users: [
    { id:1,  name:'Bolaji Olatoye',        role:'Leadership',           level:'admin', pin:'bp_yhwbc0',  sections:['sunday','worship','media','midweek','departments','admin'], active:true },
    ...
    { id:4,  name:'Caster Martins',        role:'Worship Leader',       level:'lead',  pin:'bp_yhsq3p',  sections:['sunday','worship'], active:true },
    { id:5,  name:'Morayo Ogungbenro',     role:'Worship — Guitar',     level:'team',  pin:'bp_yhu1z9',  sections:['sunday','worship'], active:true },
    { id:6,  name:'Laolu Ogungbenro',      role:'Worship — Drums',      level:'team',  pin:'bp_yhu4ed',  sections:['sunday','worship'], active:true },
    { id:7,  name:'Tosin Akindele',        role:'Worship — Vocals',     level:'team',  pin:'bp_yi13b9',  sections:['sunday','worship'], active:true },
    { id:8,  name:'Bolaji Adebanjo',       role:'Worship — Drums',      level:'team',  pin:'bp_yhrx9h',  sections:['sunday','worship'], active:true },
    { id:9,  name:'Auntie Pauline Tulloch',role:'Operations',           level:'lead',  pin:'bp_yhwnt1',  sections:['sunday','departments'], active:true },
    { id:10, name:'Pastor Gbenga Adebanjo',role:'Leadership',           level:'lead',  pin:'bp_yhtdhh',  sections:['sunday','departments','midweek'], active:true },
    { id:11, name:'Pastor Kayode Ogungbenro',role:'Leadership / Finance',level:'lead', pin:'bp_yhruv9',  sections:['sunday','departments'], active:true },
    { id:12, name:'Sister Petty',          role:'Operations',           level:'team',  pin:'bp_yhxd39',  sections:['sunday','departments'], active:true },
    { id:13, name:'Chinedu',               role:'Media Team',           level:'team',  pin:'bp_yi1slh',  sections:['sunday','media'], active:true },
    { id:14, name:'Terrel',                role:'Media Team',           level:'team',  pin:'bp_yi1v0l',  sections:['sunday','media'], active:true },
    { id:15, name:'Tavoy',                 role:'Media Team',           level:'team',  pin:'bp_yi1u9x',  sections:['sunday','media'], active:true },
    { id:16, name:'Noah',                  role:'Media Team',           level:'team',  pin:'bp_yi1wp1',  sections:['sunday','media'], active:true },
  ],
